...
/**
 * Creates a ReactRegistry pre-loaded with components for all 25 base nodes
 * plus the 9 interactive nodes (carousel, accordion, tabs, modal, agenda,
 * pricing). Pass additional calls to .register() to extend it with custom
 * nodes.
 */
export function createDefaultReactRegistry() {
